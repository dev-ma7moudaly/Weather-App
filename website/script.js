...
const apiKey = ",&appid=2c9addeb5f2094b7070f2f9d8ff122e0&units=metric";
...
const generateData = () => { 
  ...
  //const feelings = document.getElementById("feelings").value;
   const feelings= document.querySelector(".feeling-input").value;
...
const updatingUI = async () => {
  ...
  try {
    ...
    document.getElementById("city").innerHTML ="Weather In "+ savedData.city;
